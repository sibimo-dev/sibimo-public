...
import { getAllNews, newsCategories, getCategoryClasses } from "@/services/news.js";
      ...
      <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <Tag
            unstyled
            value="Info Desa"
            class="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-sky-500 to-cyan-500 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.2em] text-white shadow-md shadow-sky-500/30"
          />
