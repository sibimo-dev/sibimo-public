...
<template>
  <div class="absolute inset-0 overflow-hidden">
    <Transition
      mode="out-in"
      enter-active-class="transition-opacity duration-[1100ms] ease-in-out"
      leave-active-class="transition-opacity duration-[1100ms] ease-in-out"
    ...
    >
      <div :key="activeIndex" class="absolute inset-0">
        <img
          ...
          class="w-full h-full object-cover animate-hero-zoom motion-reduce:animate-none"
        />
      </div>
    </Transition>
